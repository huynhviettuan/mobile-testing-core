...
//        this.by = getBy(type, value);
    ...
    @Override
    public void submit() {
        getElement(DEFAULT_TIMEOUT).submit();
    }
    ...
    public String getText() {
        return getElement(DEFAULT_TIMEOUT).getText();
    }
    ...
    public boolean isDisplayed() {
        return driver.findElement(getBy()).isDisplayed();
    }
    ...
    public void format(String name) {
        // before:  //android.widget.TextView[text()='%s']
        // name = Jenny Cherry
        this.formatedValue = String.format(this.info.getValue(), name); //
        // after: //android.widget.TextView[text()='Jenny Cherry']
    }
}
